...
public class Main {
    ...
    private static void printUsage() {
        ...
        System.out.println("  create <name> -f <file>                 Modelfile / Jllmfile(.yaml/.yml)からモデルを作成");
        System.out.println("                [--binary <path>]         llama.cppバイナリのパス");
        ...
        System.out.println("  show <name> [--yaml]                    設定を表示 (--yaml でJllmfile形式)");
        System.out.println("  info <name>                             モデル詳細の表示");
        System.out.println();
        System.out.println("Modelfile example (Ollama互換):");
        ...
        System.out.println();
        System.out.println("Jllmfile example (YAML形式, .yaml/.yml/Jllmfile):");
        System.out.println("  from: /path/to/model.gguf");
        System.out.println("  system: \"You are a helpful assistant.\"");
        System.out.println("  parameters:");
